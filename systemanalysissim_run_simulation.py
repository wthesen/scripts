...
'''
    ...
    Example: Running a System analysis simulation
'''
...
parameters = {
    Parameters.SystemAnalysisSimulation.BRANCHTERMINATOR:"FL-2",
    Parameters.SystemAnalysisSimulation.OUTLETPRESSURE:600,  #psia
    Parameters.SystemAnalysisSimulation.LIQUIDFLOWRATE:3000,  #stb/d
...
print("Running System analysis simulation")
results = model.tasks.systemanalysissimulation.run(producer="Well",
