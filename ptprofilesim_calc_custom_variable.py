...
parameters = {
    ...
    Parameters.PTProfileSimulation.FLOWRATETYPE:Constants.FlowRateType.LIQUIDFLOWRATE,
                     Parameters.SystemAnalysisSimulation.BRANCHTERMINATOR:"FL-1",
    ...
    Parameters.PTProfileSimulation.CUSTOMVARIABLE: {
         ...
         Parameters.PTProfileSimulation.CustomVariable.MINVALUE:1,  #in
         Parameters.PTProfileSimulation.CustomVariable.MAXVALUE:10, #in
         }
    }
